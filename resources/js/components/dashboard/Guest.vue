        ...
        <div class="row">
            ...
            <div class="col-5 border">
                ...
                <div class="container  card-panel" v-else>
                    <div class="container  card-panel" v-if="props.is_role === 'demo'">
                        <a href="/admin/register" class="btn_inscribase"></a>
                    </div>

                    <div class="container  card-panel" v-if="props.is_role === 'admin'">

                        <div class="row">
                            <div class="col-6">  <BarChart />
                            </div>
                            <div class="col-6"><PieChart /></div>
                        </div>
                        <div class="row">
                            <div class="col-12"><LineChart /></div>
                        </div>

                    </div>


                    <div class="container  card-panel" v-if="props.is_role === 'authenticated'">

                        <div class="row">
                            <div class="col-6">  <BarChart />
                            </div>
                            <div class="col-6">Total de Ventas</div>
                        </div>
                        <div class="row">
                            <div class="col-12"><LineChart /></div>
                        </div>
